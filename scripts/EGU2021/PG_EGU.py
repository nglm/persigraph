...
# type: str
PATH_FIG_PARENT = (
    "/home/natacha/Documents/tmp/figs/PG/EGU/"
)
...
def add_annotation(
    ...
    letter,
    clean = True,
    xloc = 0.01,    # Location of the corner of the annotation
    yloc = 0.01,    # Location of the corner of the annotation
    xwdith = 0.03,  # Width of cleaned rectangle of the annotation
    ywidth = 0.03,  # Width of cleaned rectangle of the annotation
    fontsize = 27,  # annotation fontisize
    ):
...
def select_best_examples():
    ...
    def sandy():
        ...
        ax2 = add_annotation(ax2, 'c)', xwdith=0.07, ywidth=0.07)
        # fig_suptitle = filename + "\n" + d['var_name']
        # fig.suptitle(fig_suptitle)
