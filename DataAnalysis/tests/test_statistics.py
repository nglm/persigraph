...
# ------
# To test print outputs
# Source: https://stackoverflow.com/questions/4219717/how-to-assert-output-with-nosetest-unittest-in-python/31281467
import sys
...
nc = Dataset('/home/natacha/Documents/Work/PhD/Data/Bergen/ec.ens.2020011400.sfc.meteogram.nc','r')
d = 6
...
class TestPrint_dict(unittest.TestCase):
    
    def test_print_dict(self):
        with open("test_output_print_dict_01.txt", "r") as file:
